...
const maxSpendUsd = Number.parseFloat(process.env.ENDURANCE_MAX_SPEND_USD ?? "0.08");
...
const quoteSizes = [100, 250, 500, 501, 520, 600, 750, 1000];
const submitSizes = [100, 250, 500, 750, 1000];
